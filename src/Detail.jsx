    ...
    <Container fluid="md p-4">
           <Row>
            ...
            <Col xs={12} sm={6} md={8} lg={8} className="p-3 my-3 img-block postition-relative">
                ...
                <p className=" uppercase text-custom-title"><a href="" className="text-decoration-none text-custom-title">Card Title</a></p>
...
<span className="text-custom-title">Băng thông :</span><span className="text-custom-title">Băng thông quốc tế</span>
                ...
                <p className="text-custom"><span className="text-custom-title">Mô tả :</span>Dùng rất là sướng, nhanh mạnh khỏe, chơi game mượt, ưu đãi tốt, được nhiều idol recomend</p>
